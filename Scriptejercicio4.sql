...
CREATE TABLE IF NOT EXISTS `ejercicio3`.`UF` (
  ...
  PRIMARY KEY (`Codigo`),
  INDEX `fk_UF_MODULO_idx` (`MODULO_Codigo` ASC) VISIBLE,
  INDEX `fk_UF_NOTAS1_idx` (`NOTAS_idNOTAS` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ejercicio3`.`MODULO_has_ALUMNO` (
  ...
  INDEX `fk_MODULO_has_ALUMNO_ALUMNO1_idx` (`ALUMNO_Nombre_alumno` ASC) VISIBLE,
  INDEX `fk_MODULO_has_ALUMNO_MODULO1_idx` (`MODULO_Codigo` ASC) VISIBLE,
...
START TRANSACTION;
USE `ejercicio3`;
INSERT INTO `ejercicio3`.`MODULO` (`Codigo`, `Nombre`) VALUES ('m3', 'POO');
INSERT INTO `ejercicio3`.`MODULO` (`Codigo`, `Nombre`) VALUES ('m1', 'sistemas');
